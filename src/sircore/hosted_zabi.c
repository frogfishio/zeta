...
#ifndef SIR_HAVE_ZINGCORE25
  // No hosted fallback for golden caps: require zingcore ("the real thing").
  if ((strcmp(found->kind, "sys") == 0 && strcmp(found->name, "loop") == 0) ||
      (strcmp(found->kind, "file") == 0 && strcmp(found->name, "aio") == 0) ||
      (strcmp(found->kind, "net") == 0 && strcmp(found->name, "tcp") == 0) ||
      (strcmp(found->kind, "proc") == 0 && strcmp(found->name, "argv") == 0) ||
      (strcmp(found->kind, "proc") == 0 && strcmp(found->name, "env") == 0) ||
      (strcmp(found->kind, "sys") == 0 && strcmp(found->name, "info") == 0)) {
    (void)params_ptr;
    (void)params_len;
    return (zi_handle_t)ZI_E_NOSYS;
  }
#endif
