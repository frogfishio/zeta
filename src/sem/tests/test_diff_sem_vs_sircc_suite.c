...
int main(void) {
  ...
  const char* fixtures[] = {
      ...
      "src/sircc/examples/simd_i32_add_extract_replace.sir.jsonl",
      "src/sircc/examples/simd_cmp_select_bool_mask.sir.jsonl",
      "src/sircc/examples/simd_shuffle_two_inputs.sir.jsonl",
