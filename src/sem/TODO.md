...
- [ ] Atomics (partial): `atomic.load.i8/i16/i32/i64`, `atomic.store.i8/i16/i32/i64`, `atomic.rmw.{add,and,or,xor,xchg}.i32` (single-thread semantics; ordering validated, ignored)
